...
from typing import Any, List, Optional, Tuple, Union, Dict, Set, Callable
from transformers.models.opt.modeling_opt import (Callable, Optional, torch, nn, Cache, ALL_ATTENTION_FUNCTIONS, deprecate_kwarg, OPTConfig, logger, __name__)
...
class OPTAttention(nn.Module):
    ...
    def forward(
        ...
        **kwargs,
        ...
        return OPTAttention_forward(self, hidden_states, past_key_values, attention_mask, layer_head_mask, output_attentions, cache_position, **kwargs)
